...
export function Sidebar({ active, onNavigate, onSearch }: SidebarProps) {
  return (
    <aside
      className="fixed left-0 top-0 h-full w-56 flex flex-col z-40 transition-colors duration-300"
