...
export const INITIAL_MEMBERS: ABSMember[] = [
  ...
  // Executive
  { id: 'luke',    name: 'Luke Sine',        role: 'President',                                             department: 'executive',  reportsTo: 'reed',   phone: '(949) 338-8813' },
  { id: 'reed',    name: 'Reed Webster',     role: 'President',                                             department: 'executive',  reportsTo: null,     phone: '(801) 498-0754', email: 'reedwebster7284@gmail.com', schoolEmail: 'deanbean@byu.edu', netId: 'deanbean', isCurrentUser: true },
  { id: 'george',  name: 'George Varvel',    role: 'VP — Subgroups',                                        department: 'executive',  reportsTo: 'reed',   phone: '(203) 609-3690' },
  { id: 'levi',    name: 'Levi Henstrom',    role: 'VP — Outreach',                                         department: 'executive',  reportsTo: 'reed',   phone: '(763) 257-6511', email: 'levi.henstrom@gmail.com' },
  { id: 'craig',   name: 'Craig Warnick',    role: 'CTO / VP of Technology',                                department: 'executive',  reportsTo: 'reed',   phone: '(801) 652-8321' },
  { id: 'emma',    name: 'Emma Miller',      role: 'Marketing President',                                   department: 'executive',  reportsTo: 'reed',   phone: '(435) 817-1525' },
  { id: 'cooper',  name: 'Cooper Andersen',  role: 'Events & Finance VP',                                   department: 'executive',  reportsTo: 'reed',   phone: '(435) 705-6408', schoolEmail: 'coop3r@byu.edu', netId: 'coop3r' },
  { id: 'loren',   name: 'Loren Stoddard',   role: 'AI Curriculum President / AI Bootcamp President',       department: 'executive',  reportsTo: 'reed',   phone: '(385) 576-5175' },
  // Outreach
