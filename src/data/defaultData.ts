  ...
  courses: [
    {
      ...
      assignments: [
        {
          id: 'asgn_mcom_1',
          courseId: 'course_mcom320',
          title: 'Data Visualization & Interpretation',
          status: 'submitted',
          dueDate: '2026-02-14',
          grade: undefined,
          weight: 10,
          notes: 'Create original data visualization with credible quantitative data; submit as PDF',
        },
        {
          id: 'asgn_mcom_2',
          courseId: 'course_mcom320',
          title: 'Outline the Article',
          status: 'submitted',
          dueDate: '2026-02-14',
          grade: undefined,
          weight: 10,
          notes: 'SMART outline/mind map with ≥6 credible sources; PDF submission',
        },
        {
          id: 'asgn_mcom_3',
          courseId: 'course_mcom320',
          title: '4.2 Pre-class Quiz (Subject/Verb Agreement)',
          status: 'graded',
          dueDate: '2026-02-17',
          grade: undefined,
          weight: 2,
          notes: 'Unlimited attempts; study Rule 15 first',
        },
        {
          id: 'asgn_mcom_4',
          courseId: 'course_mcom320',
          title: 'Grammar Unit 4 Review Quiz',
          status: 'graded',
          dueDate: '2026-02-20',
          grade: undefined,
          weight: 5,
          notes: '2 attempts with handwritten notes only',
        },
        {
          id: 'asgn_mcom_5',
          courseId: 'course_mcom320',
          title: 'Polished Rough Draft Peer Review',
          status: 'submitted',
          dueDate: '2026-02-21',
          grade: undefined,
          weight: 10,
          notes: 'Canvas Speedgrader feedback; color-coded comments on Design, Organization, Content, Grammar',
        },
        {
          id: 'asgn_mcom_6',
          courseId: 'course_mcom320',
          title: '5.1 Pre-class Quiz (Indefinite Pronouns)',
          status: 'graded',
          dueDate: '2026-02-23',
          grade: undefined,
          weight: 2,
          notes: 'Unlimited attempts; study Rule 16',
        },
        {
          id: 'asgn_mcom_7',
          courseId: 'course_mcom320',
          title: '5.2 Pre-class Quiz (Verb Tense)',
          status: 'graded',
          dueDate: '2026-02-25',
          grade: undefined,
          weight: 2,
          notes: 'Unlimited attempts; study Rule 17',
        },
        {
          id: 'asgn_mcom_8',
          courseId: 'course_mcom320',
          title: 'Oral Peer Review (GoReact)',
          status: 'submitted',
          dueDate: '2026-02-28',
          grade: undefined,
          weight: 10,
          notes: 'Screen-share & verbally explain written feedback in 4 categories',
        },
        {
          id: 'asgn_mcom_9',
          courseId: 'course_mcom320',
          title: '5.3 Pre-class Quiz (Verb Mood)',
          status: 'graded',
          dueDate: '2026-03-02',
          grade: undefined,
          weight: 2,
          notes: 'Unlimited attempts; study Rule 18',
        },
        {
          id: 'asgn_mcom_10',
          courseId: 'course_mcom320',
          title: 'Grammar Unit 5 Review Quiz',
          status: 'graded',
          dueDate: '2026-03-06',
          grade: undefined,
          weight: 5,
        ...
        },
        {
          ...
          grade: undefined,
          weight: 5,
          notes: 'One-page: team name, goals, roles, communication, meetings, deadlines, conflict resolution, signatures',
        },
        {
          id: 'asgn_mcom_12',
          courseId: 'course_mcom320',
          ...
          grade: undefined,
          weight: 20,
          notes: 'Submit polished PDF; naming: lastname_firstname_finalarticle.pdf',
        },
        {
          id: 'asgn_mcom_13',
          courseId: 'course_mcom320',
          title: 'Practice Grammar Exam',
          status: 'submitted',
          dueDate: '2026-03-14',
          grade: undefined,
          weight: 0,
          notes: '3 attempts; 45-minute time limit; ungraded',
        },
        {
          id: 'asgn_mcom_14',
          courseId: 'course_mcom320',
          title: 'Grammar Exam (Proctored)',
          status: 'not-started',
          dueDate: '2026-03-21',
          grade: undefined,
          weight: 50,
          notes: '50 points; 75 minutes; Proctorio remote proctoring; expires midnight',
        },
        {
          id: 'asgn_mcom_15',
          courseId: 'course_mcom320',
          title: 'Team Meeting with Professor',
          status: 'not-started',
          dueDate: '2026-03-21',
          grade: undefined,
          weight: 5,
          notes: 'All members attend; submit progress report (completed/in-progress/not started items, obstacles, action items)',
        },
        {
          id: 'asgn_mcom_16',
          courseId: 'course_mcom320',
          ...
          grade: undefined,
          weight: 10,
          notes: 'Kickoff meeting with AI notetaker; formatted minutes reflecting all required discussion items',
        },
      ],
      examDates: [
        {
